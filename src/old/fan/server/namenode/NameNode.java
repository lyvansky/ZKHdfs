package old.fan.server.namenode;
...
import old.fan.server.ops.NNOperationsAPI;
import old.fan.server.ops.TxnState;
import old.fan.server.ops.ZookeeperOperations;
...
public class NameNode {
	...
	public static void main(String[] args) {
		...
		listen.start();
		if (!nn.isCoordinator) {// NN is not the coordinator, non-coordinator NN reply to coordinator
